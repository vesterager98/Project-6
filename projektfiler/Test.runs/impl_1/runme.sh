...
HD_PWD='C:/Users/stump/OneDrive/Skrivebord/Vivado/Test/Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ReadTest.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ReadTest.tcl -notrace
