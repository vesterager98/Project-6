...
HD_PWD='C:/Users/stump/OneDrive/Skrivebord/Vivado/Test/Test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ReadTest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ReadTest.tcl
